...
import com.hawker.shiro.MyShiroRealm;
...
public class ShiroConfig {
    ...
    // cas server地址
    public static final String casServerUrlPrefix = "http://cas.hawker.local:8080/cas";
    // Cas登录页面地址
    public static final String casLoginUrl = casServerUrlPrefix + "/login";
    // Cas登出页面地址
    public static final String casLogoutUrl = casServerUrlPrefix + "/logout";
    // 当前工程对外提供的服务地址
    public static final String shiroServerUrlPrefix = "http://127.0.0.1:8681";
    ...
    public static final String logoutUrl = casLogoutUrl;
    // 登录成功地址
...
//      <!-- 用户授权/认证信息Cache, 采用EhCache 缓存 -->
    ...
    public ShiroFilterFactoryBean getShiroFilterFactoryBean(DefaultWebSecurityManager securityManager, CasFilter casFilter, ResourcesService service) {
        ...
        // 登录成功后要跳转的连接
        shiroFilterFactoryBean.setSuccessUrl(shiroServerUrlPrefix+"/usersPage");
     ...
     * @create 2016年1月14日
     */
//    private void loadShiroFilterChain(ShiroFilterFactoryBean shiroFilterFactoryBean, ResourcesService service) {
//        /////////////////////// 下面这些规则配置最好配置到配置文件中 ///////////////////////
...
//        //自定义加载权限资源关系
//        List<Resources> resourcesList = service.queryAll();
